...
| P1 | Enhance same-site overlap evidence | Complete for paired POC analysis | 11 qualified daily and 9 hourly alternate-POC pairs; daily/hourly direction agreement is 8/9 and each cross-site method is directionally consistent in 7/8 comparable cases. Targeted cross-family document review remains separate |
