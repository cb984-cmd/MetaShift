...
| P1 | Enhance same-site overlap evidence | In progress | `configs/same_site_overlap_consistency_v1.json` fixes daily/hourly pairing and noncausal direction/rank comparisons with saved cross-site residuals |
